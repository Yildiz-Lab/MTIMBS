function MTIMBS_ncolor_wrapper(top_folder)

%% Authors: Jon Fernandes and Joseph Slivka and Parnika Kant!
% Last Updated: 2024/10/23
%% Description:

% Removes the saving opts for quick debugging and playing with of bad images
% (useful for programmers, not for the user)
