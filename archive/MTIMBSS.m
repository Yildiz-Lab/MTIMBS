function [corrected_intensities] = MTIMBSS(filename, savedmts)

%% Authors: Jon Fernandes and Joseph Slivka and Parnika!
%  Date: Feb 10, 2022
...
%ridge_threshold_2 = previous_ridge_threshold;
...
%     %show us the points that are picked out by the line
    ...
    [corrected_intensities(i), mean_intensities(i), background_intensities(i) ] = intensity_measurement(savedmts{i},image);
